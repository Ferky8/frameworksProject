        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected pr.justeat.dao.dto.xsd.Cliente localCliente ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  pr.justeat.dao.dto.xsd.Cliente getCliente(){
                               return localCliente;
                           }
                            ...
                            /**
                               ...
                               * @param param Cliente
                               */
                               public void setCliente(pr.justeat.dao.dto.xsd.Cliente param){
                ...
                if (localDniTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localCliente==null){
                                        ...
                                        writeStartElement(null, "http://dao.justeat.pr", "cliente", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localCliente.serialize(new javax.xml.namespace.QName("http://dao.justeat.pr","cliente"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"actualizarCliente".equals(type)){
                                ...
                                return (ActualizarCliente)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","cliente").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setCliente(pr.justeat.dao.dto.xsd.Cliente.Factory.parse(reader));

 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected pr.justeat.dao.dto.xsd.Elemento localElemento ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isElementoSpecified(){
                               return localElementoTracker;
                           }
                           ...
                           */
                           public  pr.justeat.dao.dto.xsd.Elemento getElemento(){
                            ...
                            /**
                               ...
                               */
                               public void setElemento(pr.justeat.dao.dto.xsd.Elemento param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":actualizarElemento",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "actualizarElemento",
                           xmlWriter);
                              ...
                              if (localElementoTracker){
                                    if (localElemento==null){
                                        ...
                                        writeStartElement(null, "http://dao.justeat.pr", "elemento", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localElemento.serialize(new javax.xml.namespace.QName("http://dao.justeat.pr","elemento"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static ActualizarElemento parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActualizarElemento object =
                new ActualizarElemento();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"actualizarElemento".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActualizarElemento)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","idElemento").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","elemento").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setElemento(pr.justeat.dao.dto.xsd.Elemento.Factory.parse(reader));

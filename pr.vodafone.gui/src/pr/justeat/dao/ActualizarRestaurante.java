 ...
 */
            ...
            /**
            *  ActualizarRestaurante bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected pr.justeat.dao.dto.xsd.Restaurante localRestaurante ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  pr.justeat.dao.dto.xsd.Restaurante getRestaurante(){
                            ...
                            /**
                               ...
                               */
                               public void setRestaurante(pr.justeat.dao.dto.xsd.Restaurante param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":actualizarRestaurante",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "actualizarRestaurante",
                ...
                if (localIdRestauranteTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localRestaurante==null){
                                        ...
                                        writeStartElement(null, "http://dao.justeat.pr", "restaurante", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localRestaurante.serialize(new javax.xml.namespace.QName("http://dao.justeat.pr","restaurante"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static ActualizarRestaurante parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActualizarRestaurante object =
                new ActualizarRestaurante();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"actualizarRestaurante".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActualizarRestaurante)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","idRestaurante").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","restaurante").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setRestaurante(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setRestaurante(pr.justeat.dao.dto.xsd.Restaurante.Factory.parse(reader));

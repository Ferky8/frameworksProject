 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":borrarElementos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "borrarElementos",
    ...
    public static class Factory{
        ...
        */
        public static BorrarElementos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BorrarElementos object =
                new BorrarElementos();

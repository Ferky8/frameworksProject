 ...
 */
            ...
            /**
            *  BorrarRestaurante bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BorrarRestaurante
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":borrarRestaurante",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "borrarRestaurante",
    ...
    public static class Factory{
        ...
        */
        public static BorrarRestaurante parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BorrarRestaurante object =
                new BorrarRestaurante();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"borrarRestaurante".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BorrarRestaurante)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

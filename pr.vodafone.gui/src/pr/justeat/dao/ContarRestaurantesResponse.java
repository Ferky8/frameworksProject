...
/**
 * ContarRestaurantesResponse.java
 *
 ...
 */
            ...
            /**
            *  ContarRestaurantesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ContarRestaurantesResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://dao.justeat.pr",
                "contarRestaurantesResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":contarRestaurantesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "contarRestaurantesResponse",
    ...
    public static class Factory{
        ...
        */
        public static ContarRestaurantesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ContarRestaurantesResponse object =
                new ContarRestaurantesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"contarRestaurantesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ContarRestaurantesResponse)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

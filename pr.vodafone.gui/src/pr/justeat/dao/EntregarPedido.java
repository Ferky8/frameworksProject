 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":entregarPedido",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "entregarPedido",
    ...
    public static class Factory{
        ...
        */
        public static EntregarPedido parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EntregarPedido object =
                new EntregarPedido();

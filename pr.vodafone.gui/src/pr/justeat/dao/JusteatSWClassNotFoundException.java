...
/**
 * JusteatSWClassNotFoundException.java
 *
 ...
 */
            ...
            /**
            *  JusteatSWClassNotFoundException bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class JusteatSWClassNotFoundException
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://dao.justeat.pr",
                "JusteatSWClassNotFoundException",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":JusteatSWClassNotFoundException",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "JusteatSWClassNotFoundException",
                            ...
                            if (localClassNotFoundException!=null){
                                if (localClassNotFoundException instanceof org.apache.axis2.databinding.ADBBean){
                                    ((org.apache.axis2.databinding.ADBBean)localClassNotFoundException).serialize(
                                               new javax.xml.namespace.QName("http://dao.justeat.pr","ClassNotFoundException"),
                                               xmlWriter,true);
                                 } else {
                                    writeStartElement(null, "http://dao.justeat.pr", "ClassNotFoundException", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static JusteatSWClassNotFoundException parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            JusteatSWClassNotFoundException object =
                new JusteatSWClassNotFoundException();

 ...
 */
            ...
            /**
            *  ObtenerElementosPedido bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerElementosPedido
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerElementosPedido",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerElementosPedido",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerElementosPedido parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerElementosPedido object =
                new ObtenerElementosPedido();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerElementosPedido".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerElementosPedido)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  ObtenerPedidosEntregados bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerPedidosEntregados
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerPedidosEntregados",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerPedidosEntregados",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerPedidosEntregados parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerPedidosEntregados object =
                new ObtenerPedidosEntregados();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerPedidosEntregados".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerPedidosEntregados)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

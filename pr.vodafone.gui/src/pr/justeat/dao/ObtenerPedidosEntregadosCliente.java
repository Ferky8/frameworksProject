...
/**
 * ObtenerPedidosEntregadosCliente.java
 *
 ...
 */
            ...
            /**
            *  ObtenerPedidosEntregadosCliente bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerPedidosEntregadosCliente
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerPedidosEntregadosCliente",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerPedidosEntregadosCliente",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerPedidosEntregadosCliente parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerPedidosEntregadosCliente object =
                new ObtenerPedidosEntregadosCliente();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerPedidosEntregadosCliente".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerPedidosEntregadosCliente)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","entregado").equals(reader.getName())){

...
/**
 * ObtenerRestaurantesPorNombre.java
 *
 ...
 */
            ...
            /**
            *  ObtenerRestaurantesPorNombre bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerRestaurantesPorNombre
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://dao.justeat.pr",
                "obtenerRestaurantesPorNombre",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerRestaurantesPorNombre",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerRestaurantesPorNombre",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerRestaurantesPorNombre parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerRestaurantesPorNombre object =
                new ObtenerRestaurantesPorNombre();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerRestaurantesPorNombre".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerRestaurantesPorNombre)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","nombre").equals(reader.getName())){

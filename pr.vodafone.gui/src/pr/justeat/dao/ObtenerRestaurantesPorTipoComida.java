...
/**
 * ObtenerRestaurantesPorTipoComida.java
 *
 ...
 */
            ...
            /**
            *  ObtenerRestaurantesPorTipoComida bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerRestaurantesPorTipoComida
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://dao.justeat.pr",
                "obtenerRestaurantesPorTipoComida",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerRestaurantesPorTipoComida",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerRestaurantesPorTipoComida",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerRestaurantesPorTipoComida parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerRestaurantesPorTipoComida object =
                new ObtenerRestaurantesPorTipoComida();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerRestaurantesPorTipoComida".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerRestaurantesPorTipoComida)resource.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.justeat.pr","tipoComida").equals(reader.getName())){
